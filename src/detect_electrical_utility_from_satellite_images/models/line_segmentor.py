...
class UNet(nn.Module):
    ...
    def __init__(
        ...
        self.down4 = Down(f * 8, f * 16 // factor)  # 1024 or 512

        # Decoder
        self.up1 = Up(f * 16, f * 8 // factor, bilinear)  # 512 or 256
        self.up2 = Up(f * 8, f * 4 // factor, bilinear)  # 256 or 128
        self.up3 = Up(f * 4, f * 2 // factor, bilinear)  # 128 or 64
